...
#Gera a página Torneios_Atuais

def torneio_atuais():
    f = open(f'torneios_atuais.html','w')
    ...
    lista = ""
    for estado in ("A decorrer", "Em breve"):
        for comp in (atp, wta):
            if len(comp) != 0:
                for t in dict.keys(comp):
                    if comp[t]['estado'] == estado:
    ...
    <body>
        <div id="nav-placeholder"></div>
            ...
            <div class="big-logo">
        <div class="container">
            <h1 class="titulo">Torneios <span>Atuais</span></h1>
        </div>        
    </div>
        {lista_html}
    </body>
    ...
    print('Torneios Atuais: atualizado')